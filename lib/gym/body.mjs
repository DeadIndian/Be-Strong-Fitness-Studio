...
export const CLIPS = {
	...
	sit: {
		...
		root: { y: -0.35, z: -0.12 },
		keys: [
			{ p: 0, pose: { thighL: [-1.5, 0, 0.06], thighR: [-1.5, 0, -0.06], shinL: [0, 0, 0], shinR: [0, 0, 0], footL: [-0.2, 0, 0], footR: [-0.2, 0, 0], spine: [-0.16, 0, 0], chest: [-0.12, 0, 0], neck: [0.14, 0, 0], upperArmL: [0, 0, 0.3], upperArmR: [0, 0, -0.3], foreArmL: [-0.85, 0, 0], foreArmR: [-0.85, 0, 0] } },
			{ p: 0.5, pose: { thighL: [-1.48, 0, 0.06], thighR: [-1.52, 0, -0.06], shinL: [0, 0, 0], shinR: [0, 0, 0], footL: [-0.16, 0, 0], footR: [-0.24, 0, 0], spine: [-0.2, 0, 0], chest: [-0.16, 0, 0], neck: [0.18, 0, 0], upperArmL: [0, 0, 0.34], upperArmR: [0, 0, -0.34], foreArmL: [-0.8, 0, 0], foreArmR: [-0.8, 0, 0] } },
		],
	},
